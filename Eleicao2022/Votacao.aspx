...
<body style="height: 359px">
    <form id="form1" runat="server">
        <div class="auto-style2">
            ...
            &nbsp;<br />
            <asp:TextBox ID="TbResultado" runat="server" Height="33px" Width="314px"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;<br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="BtnBranco" runat="server" BackColor="White" Text="Branco" Width="71px" OnClick="BtnBranco_Click" />
            <asp:Button ID="BtnCorrigir" runat="server" BackColor="#CC3300" CssClass="auto-style12" Text="Corrigir" Width="71px" OnClick="BtnCorrigir_Click" />
            &nbsp;
            <asp:Button ID="BtnNulo" runat="server" BackColor="#FF6600" CssClass="auto-style13" Text="Nulo" Width="71px" OnClick="BtnNulo_Click" />
            <asp:Button ID="BtnConfirmar" runat="server" BackColor="#33CC33" CssClass="auto-style3" OnClick="BtnConfirmar_Click" Text="Confirmar" Width="72px" Height="24px" />
            <br />
&nbsp;
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
